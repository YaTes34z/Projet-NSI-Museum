...
personnage = pygame.image.load('images/homme_droit.png')  # Remplace par le chemin de ton image
...
def toggle_map():
    global map
    map = not map  # Change l'état de la carte

def draw_map():
    if map:
        # Afficher la carte en surimpression
        ...
        # Dessiner un point rouge pour le joueur
        pygame.draw.circle(WIN, (255, 0, 0), (player_map_x, player_map_y), 10)

        # Ajouter du texte pour quitter la carte
        font = pygame.font.Font(None, 50)
        text = font.render("Appuyez sur 'E' pour fermer la carte", True, (255, 255, 255))
        text_rect = text.get_rect(center=(largeur // 2, hauteur - 50))
        WIN.blit(text, text_rect)
...
battery_blink_interval = 180  # en millisecondes
